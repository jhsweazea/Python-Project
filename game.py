...
things = {
    ...
    "health": item_model.Item(7, "health potion", "The small, thin vial fits inside the palm of your hand. A faint red emanation is pulsing from within."),
    ...
    "shield": item_model.Weapon(10, "shield", "The large wooden shield, although decorative, was definitely made to be used. DEF: 2",0, 2),
